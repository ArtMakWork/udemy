...
/* state */
{
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      textMessage.textContent = message.loadind;
...
var modals = function modals() {
  ...
  function openByScroll(selector) {
    window.addEventListener('scroll', function () {
      var clH = Math.floor(window.pageYOffset + document.documentElement.clientHeight);
      var wH = Math.floor(document.documentElement.scrollHeight);
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  btn.addEventListener('click', function () {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getResource"])('assets/db.json') //getResource('http://localhost:3000/styles')
